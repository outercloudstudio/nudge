...
class MatchFooter(object):
  ...
  def Winner(self) -> int: ...
  def WinType(self) -> typing.Literal[WinType.RESIGNATION, WinType.RATKING_DESTROYED, WinType.BACKSTAB_RATKING_DESTROYED, WinType.MORE_POINTS, WinType.TIE, WinType.COIN_FLIP]: ...
...
def MatchFooterAddWinType(builder: flatbuffers.Builder, winType: typing.Literal[WinType.RESIGNATION, WinType.RATKING_DESTROYED, WinType.BACKSTAB_RATKING_DESTROYED, WinType.MORE_POINTS, WinType.TIE, WinType.COIN_FLIP]) -> None: ...
