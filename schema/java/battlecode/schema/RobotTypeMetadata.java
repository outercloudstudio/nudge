...
public final class RobotTypeMetadata extends Table {
  ...
  public int turningCooldown() { int o = __offset(22); return o != 0 ? bb.getInt(o + bb_pos) : 0; }
  ...
  public static void addTurningCooldown(FlatBufferBuilder builder, int turningCooldown) { builder.addInt(9, turningCooldown, 0); }
